...
class TestCrawlerURLNormalization:
    ...
    def test_strip_fragment(self):
        ...
        assert (
            Crawler._normalize_url("http://example.com/page#section")
    ...
    def test_strip_trailing_slash(self):
        ...
        assert (
            Crawler._normalize_url("http://example.com/page/")
            == "http://example.com/page"
        )
...
class TestIDORScanner:
    ...
    def test_error_page_detection(self):
        ...
        normal_text = (
            "<html><body><h1>User Profile</h1><p>Welcome, John!</p></body></html>"
        )
...
class TestCommandInjectionScanner:
    ...
    def test_detects_passwd_output(self):
        from app.scanner.vulnerabilities.command_injection import (
...
class TestDirectoryTraversalScanner:
    ...
    def test_detects_passwd_content(self):
        from app.scanner.vulnerabilities.directory_traversal import (
            DirectoryTraversalScanner,
        )

        scanner = DirectoryTraversalScanner()

        found, evidence = scanner._check_traversal("root:x:0:0:root:/root:/bin/bash")
        assert found is True
    ...
    def test_detects_windows_ini(self):
        ...
        found, evidence = scanner._check_traversal("[fonts]\n[extensions]\nfoo=bar")
        assert found is True
