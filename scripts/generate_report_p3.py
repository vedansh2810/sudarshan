...
add_figure(
    os.path.join(DIAGRAM_DIR, "ai_ml_integration.png"),
...
add_table_with_data(
    ...
    [
        [
            ...
            "Tech stack, WAF, framework detection",
            "Phase 1.5",
        ],
        [
            "Smart Payloads",
            "Vuln type + target context",
            "Context-aware attack payloads",
            "Phase 2",
        ],
        [
            "WAF Bypass",
            "WAF type + blocked payload",
            "Evasion variants using encoding tricks",
            "Phase 2",
        ],
        [
            "Finding Verification",
            "Payload + response evidence",
            "FP probability (0.0-1.0)",
            "Phase 2",
        ],
        [
            "Attack Narrative",
            "Vulnerability details + evidence",
            "Professional exploitation writeup",
            "Phase 3",
        ],
        [
            "Report Writing",
            "All findings + scan metadata",
            "Executive summary + remediation plan",
            "Phase 3",
        ],
    ],
    "4.1",
    "LLM Functions in the Scan Pipeline",
)
...
add_bullet(
    "Payload characteristics: length, encoding type, complexity score, special character ratio"
)
add_bullet(
    "Response analysis: HTTP status code, response time, content length delta from baseline"
)
add_bullet(
    "Content indicators: presence of error messages, stack traces, SQL error patterns"
)
add_bullet(
    "Behavioral signals: reflection of payload in response, parameter position (URL, body, header)"
)
...
add_table_with_data(
    ...
    [
        [
            ...
            "SQL Injection",
            "A03:2021 Injection",
            "Error-based, blind boolean, time-based",
        ],
        [
            "xss.py",
        ...
        [
            ...
            "Token absence & validation checks",
        ],
        [
        ...
        [
            ...
            "Algorithm confusion, none algo",
        ],
        [
            "broken_auth.py",
            "Broken Authentication",
            "A07:2021 Auth Failures",
            "Default creds, session checks",
        ],
        [
            "idor.py",
            "IDOR",
            "A01:2021 Broken Access Control",
            "ID enumeration & reference checks",
        ],
        [
            "open_redirect.py",
            "Open Redirect",
        ...
        [
            ...
            "A05:2021 Misconfiguration",
            "Origin header reflection tests",
        ],
        [
            "clickjacking.py",
            "Clickjacking",
...
add_table_with_data(
    ...
    "5.2",
    "Scan Speed Configuration Profiles",
)
